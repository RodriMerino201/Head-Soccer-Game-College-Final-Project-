...
public class FXMLControllerPlayer1 implements Initializable{
    ...
    @FXML void onClickBack(ActionEvent event) throws Exception{
        FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\fxml\\gameMenu.fxml").toURI().toURL());
    ...
    @FXML synchronized void onClickConfirm(ActionEvent event) throws Exception{
        if(rbcharacter1.isSelected()||rbcharacter2.isSelected()||rbcharacter3.isSelected()){
            ...
            FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\fxml\\gameReady1.fxml").toURI().toURL());
            Parent root = loader.load();
            Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
            Scene scene = new Scene(root);
            stage.setTitle("HeadSoccer");
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        rbcharacter1.setOnAction(e -> {
            if (rbcharacter1.isSelected()){
                Image image = new Image(new File("C:\\Users\\rodri\\Downloads\\soccerGameProject\\src\\main\\Resources\\images\\player1_1.png").toURI().toString());
        ...
        rbcharacter2.setOnAction(e -> {
            if (rbcharacter2.isSelected()){
                Image image = new Image(new File("C:\\Users\\rodri\\Downloads\\soccerGameProject\\src\\main\\Resources\\images\\player2_1.png").toURI().toString());
                imagePane.getChildren().clear();
                imagePane.getChildren().add(new ImageView(image));
        ...
        rbcharacter3.setOnAction(e -> {
            if (rbcharacter3.isSelected()){
                Image image = new Image(new File("C:\\Users\\rodri\\Downloads\\soccerGameProject\\src\\main\\Resources\\images\\player3_1.png").toURI().toString());
                imagePane.getChildren().clear();
                imagePane.getChildren().add(new ImageView(image));
