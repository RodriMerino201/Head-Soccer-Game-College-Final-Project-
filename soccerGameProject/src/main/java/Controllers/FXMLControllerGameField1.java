...
public class FXMLControllerGameField1 implements Initializable, Runnable{
    ...
    Image gameFieldImage = new Image(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\images\\soccer_field_background.jpg").toURI().toString());
    ...
    @FXML void onClickExit(ActionEvent event) throws Exception{
        FXMLLoader load1 = new FXMLLoader(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\fxml\\gameOver1.fxml").toURI().toURL());
