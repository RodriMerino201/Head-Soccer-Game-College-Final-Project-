...
public class FXMLControllerGameMenu extends Main{
    ...
    @FXML void onClickPlayer1(ActionEvent event) throws Exception{
       FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\fxml\\characterSelection1.fxml").toURI().toURL());
    ...
    @FXML void onClickPlayer2(ActionEvent event) throws Exception{
       FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\fxml\\characterSelection2.fxml").toURI().toURL());
       Parent root = loader.load();
       Stage stage= (Stage) ((Node)event.getSource()).getScene().getWindow();
       Scene scene = new Scene(root);
       stage.setTitle("HeadSoccer");
    ...
    @FXML void onClickInfo(ActionEvent event) throws Exception{
        FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\rodri\\Desktop\\soccerGameProject\\src\\main\\Resources\\fxml\\info.fxml").toURI().toURL());
        Parent root = loader.load();
        Stage stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        stage.setTitle("HeadSoccer");
        Pane pane = new Pane();
